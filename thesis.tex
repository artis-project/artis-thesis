...
\usepackage{unizhdt}
\usepackage{forest}
%%% Abbreviations and Glossary configurations %%%
...
% removes In: in the bibliography
\renewbibmacro{in:}{}
% allows for line breaks in the bibliography
\setcounter{biburllcpenalty}{7000}
\setcounter{biburlucpenalty}{8000}
% custom bibliography driver for websites
...
\title{ARTIS - Art Tracking with IoT and Blockchains}
...
\printglossary[type=abbreviations, title=Abbreviations, style=mcolindex]
