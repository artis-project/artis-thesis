...
During the transportation the logger stored every sensor reading in a local database. 

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{diagrams/sensor_eval.drawio.pdf}
