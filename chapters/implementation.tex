...
The \texttt{ArtworkConnector} class basically has the same interface as the solidity contract. Each public method directly connects to a \gls{sc} method.

\lstinputlisting[
    language=Python,
    caption=ArtworkConnector class,
